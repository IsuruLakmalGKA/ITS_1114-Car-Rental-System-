          ...
          <Grid container direction='column' alignItems={'center'} justifyContent='center' className=" h-20 w-56">
            <Grid container gap="10px" direction="row" justifyContent={'center'} alignItems='center' className="">
              ...
              <Grid container direction="column" item className=" w-40">
                ...
                <Grid>
                  <Typography variant="p">Baduraeliya, Kalutara</Typography>
                </Grid>
              </Grid>
            </Grid>
          </Grid>
          ...
          <Grid container direction='column' alignItems={'center'} justifyContent='center' className=" h-20 w-56">
            <Grid container gap="10px" direction="row" justifyContent={'center'} alignItems='center' className="">
              ...
              <Grid container direction="column" item className=" w-40">
                ...
                <Grid>
                  <Typography variant="p">rentCar@test.com</Typography>
                </Grid>
              </Grid>
            </Grid>
          </Grid>
          ...
          <Grid container direction='column' alignItems={'center'} justifyContent='center' className=" h-20 w-56">
            <Grid container gap="10px" direction="row" justifyContent={'center'} alignItems='center' className="">
              ...
              <Grid container direction="column" item className=" w-40">
                ...
                <Grid>
                  <Typography variant="p">+94 768115909</Typography>
                </Grid>
              </Grid>
            </Grid>
          </Grid>
            ...
            >
              ...
              >
                <Typography variant="p" className="text-center">
                  Copyright © 2022. Isuru Lakmal. All right reserved
                </Typography>
              </Grid>
            </Grid>
          </Grid>
